;; -*- lisp-version: "10.1 [64-bit Windows *SMP*] (Nov 30, 2021 9:53)"; -*-

(in-package :cg-user)

(define-project :name :PropositionalLogic
  :modules (list (make-instance 'module :name "utilities.lisp")
                 (make-instance 'module :name "unify.lisp")
                 (make-instance 'module :name "infix.lisp")
                 (make-instance 'module :name "normal.lisp")
                 (make-instance 'module :name "prop.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
